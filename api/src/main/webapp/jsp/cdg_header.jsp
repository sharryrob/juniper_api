    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-stretch">
      	<div class="navbar-nav navbar-nav-left">
			<font color="black"><b>${project}</b></font>&nbsp<font size="2" color="red"><b>(API)</b></font>
        </div>
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile dropdown">
           ...
           <c:choose>
			    <c:when test="${user=='admin'}"><img src="${pageContext.request.contextPath}/assets/img/faces/jiten.jpg" alt="image"></c:when>
			    <c:when test="${user=='vaibhav'}"><img src="${pageContext.request.contextPath}/assets/img/faces/face.png" alt="image"></c:when>
			    <c:when test="${user=='abhishek'}"><img src="${pageContext.request.contextPath}/assets/img/faces/face.png" alt="image"></c:when>
			    <c:when test="${user=='test'}"><img src="${pageContext.request.contextPath}/assets/img/faces/face.png" alt="image"></c:when>
          ...
          <li class="nav-item nav-logout d-none d-lg-block">
            <a class="nav-link" href="${pageContext.request.contextPath}/parent">
              <i class="mdi mdi-home" id="fullscreen-button"></i>
            </a>
          </li>
...
<li class="nav-item">
   <a class="nav-link" data-toggle="collapse" href="#extraction" aria-expanded="false" aria-controls="extraction"> <span class="menu-title">API</span> <i class="menu-arrow"></i> <i class="mdi mdi-database menu-icon"></i> </a> 
   <div class="collapse" id="extraction">
      <ul class="nav flex-column sub-menu">
         <li class="nav-item"> <a class="nav-link" href="/extraction/ConnectionDetailsUnix">API Connection </a></li>
      </ul>
   </div>
</li>
        </ul>
